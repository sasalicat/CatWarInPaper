	...
	void Update () {
        if (persisTime != 0)
        {
            if (tiggerleft <= 0)
            {
                ...
                transform.Find("twoD").GetComponent<unit>().beenTreat(treatNum, Caster,fromtools);
